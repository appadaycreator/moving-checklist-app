...
const SVC_URL = "https://appadaycreator.com/moving-checklist-app/";
const SVC_NAME = "引越しToDoリスト・チェックアプリ";

test.describe("引越しToDoリスト・チェックアプリ - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("moving-checklist-app");
